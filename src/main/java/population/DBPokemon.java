...
public class DBPokemon {
    ...
    public DBPokemon(int id, String name) {
        this.id = id;
        this.name = name;
    }

    public DBPokemon(int id, String name, String intName, int type1, int type2, int ability1, int ability2, int abilityh, String dexText) {
        this.id = id;
        this.name = name;
    ...
    public byte[] getBytesFromIcon() {
        ...
        InputStream is = DBPokemon.class.getResourceAsStream("/img/poke/" + iconResourcePath);
